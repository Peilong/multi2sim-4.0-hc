...
void accArith (long N, double *A1, double *A2, double *A3, double *A4);
...
*/
	if (!accArith(N2,&E1[1],&E1[2],&E1[3],&E1[4]))
		printf ("Success\n");
	else 
		printf ("Error\n");
...
int accArith (long N, double *A1, double *A2, double *A3, double *A4)
{
	long I;
	double T = 0.499975;
	printf ("accArith\n");
