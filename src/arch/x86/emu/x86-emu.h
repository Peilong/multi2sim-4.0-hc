...
/* 
* Accelerator related data structure 
* Author: Peilong Li
*/
...
typedef struct
{
	unsigned int  withAcc;     //0 - No Acc; 1 - with Acc
	AccType       type;        //Acc Type
	unsigned long requestsNum; //# of requests
	unsigned long prepareTime; //# of cycles elapse
	unsigned long initCycle;    //initial cycle when Acc starts
} Acc;
...
struct x86_ctx_t
{
	...
	Acc accStatus;  /* Accelerator status -- Peilong added */
};
