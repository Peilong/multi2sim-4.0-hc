...
//Data Cache Dimension = WAY * SET * OFFSET
#define WAY 4     //Peilong Added
#define SET 128   //Peilong Added
#define OFFSET 64 //Peilong Added
typedef struct DCacheCell //Peilong Added
{
	unsigned long long access;  //Access counter
	unsigned long long cycle;   //The cycle of the last access
	unsigned long long rd_sum;  //Sum of reuse distance
	unsigned long long rd;      // Reuse distance
}DCacheCell;
DCacheCell dcache [WAY][SET][OFFSET]; //Peilong Added
